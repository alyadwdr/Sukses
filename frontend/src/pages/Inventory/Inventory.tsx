  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
        <h1 style={{ color: 'var(--color-text)' }}>Inventori</h1>
        <button
            ...
            <Card style={{ boxShadow: 'var(--shadow-card)', minHeight: 420 }}>
              ...
              {stockView === 'list' ? (
                ...
                <div
                  style={{
                    display: 'grid',
                    gridTemplateColumns: `repeat(auto-fill, minmax(${sizeConfig[stockView].minWidth}px, 1fr))`,
                    gap: 12,
                  }}
                >
                  {filteredProducts.map((p) => (
            ...
            <Card style={{ boxShadow: 'var(--shadow-card)', minHeight: 420 }}>
              ...
              {loading ? (
                ...
                <div
                  style={{
                    display: 'grid',
                    gridTemplateColumns: `repeat(auto-fill, minmax(${sizeConfig[historyView].minWidth}px, 1fr))`,
                    gap: 12,
                  }}
                >
                  {filteredMovements.map((m) => (
